...
def getSentiments(userText, type):
    if(type == 'Positive/Negative/Neutral - TextBlob'):
        ...
        if(status=="Positive"):
            image = Image.open("C:/Users/Krishna/Desktop/SentimentAnalysis-Streamlit-main/images/positive.PNG")
        elif(status == "Negative"):
            image = Image.open("C:/Users/Krishna/Desktop/SentimentAnalysis-Streamlit-main/images/negative.PNG")
        else:
            image = Image.open("C:/Users/Krishna/Desktop/SentimentAnalysis-Streamlit-main/images/neutral.PNG")
